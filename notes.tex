...
\def\Authors{Alexis Beingessner \\ Simon Pratt}
\def\Title{Algorithms Notes}
...
\begin{multicols}{2}
  ...
  \include{records}                     % done
  \include{random_select}               % done
  \include{random_linear}               % done
  \include{random_graphs}               % done
  \include{probabilistic_method}        % done
